...
Add a dependency on com.github.dylon:liblevenshtein:2.1.1 to your project's <code>build.gradle</code>:

```groovy
// ...
dependencies {
  compile 'com.github.dylon:liblevenshtein:2.1.1'
}
// ...
```
...
Add a dependency on com.github.dylon:liblevenshtein:2.1.1 to your project's POM:
